...
def _derive_syntax_sets(data: dict) -> tuple[set, set, set, set, set]:
    ...
    allowed_bundle_types = set(data.get("bundleTypes", {}).keys())
    ...
    deprecated_promise_types = {
        name
        for name, entry in data.get("promiseTypes", {}).items()
